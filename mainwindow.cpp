...
void MainWindow::setupStartScreen()
{
    ...
    connect(startButton, &QPushButton::clicked, this, &MainWindow::showGameScreen);
...
void MainWindow::setupGameScreen()
{
    ...
    connect(statsButton, &QPushButton::clicked, this, &MainWindow::showStatsPopup);
    connect(hintsButton, &QPushButton::clicked, this, &MainWindow::showHintsPopup);
...
void MainWindow::showHintsPopup()
{
    ...
    hintsDialog->setWindowTitle("Hints");
    ...
    // Add a close button to the popup
    QPushButton *closeButton = new QPushButton("Close");
    connect(closeButton, &QPushButton::clicked, hintsDialog, &QDialog::close);
    layout->addWidget(closeButton);
